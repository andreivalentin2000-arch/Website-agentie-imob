    ...
    <Section tone="cream">
      <Container>
        <Reveal className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-end">
          <div>
            <Eyebrow>Curated Properties</Eyebrow>
            <h2 className="mt-5 max-w-xl font-display text-3xl font-light leading-tight text-brown md:text-4xl">
              Curated rural properties. Not endless listings.
            </h2>
            <p className="mt-4 max-w-lg font-body text-[15px] leading-relaxed text-brown/60">
              We do not list every house we find. We select properties with real lifestyle
              potential, strong character and verified paperwork.
            </p>
          </div>
